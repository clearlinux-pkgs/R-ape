...
Version  : 5.6.2
Release  : 54
URL      : https://cran.r-project.org/src/contrib/ape_5.6-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ape_5.6-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646241765
